...
public class DiaryBehavior2 : MonoBehaviour
{
    private AudioClip diarySound;
    ...
    void Start()
    {
        ...
        diarySound = Resources.Load<AudioClip>("Sounds/日记音效");
        ...
        {
            myImage.sprite = Resources.Load("Image/diary1234", typeof(Sprite)) as Sprite;
        }
    ...
    void UpdateImage()
    {
        if (needUpdate)
        {
            ...
            if (specialPiece.CompareTag("Piece4")) {
                ...
                {
                    myImage.sprite = Resources.Load("Image/diary123", typeof(Sprite)) as Sprite;
                }
                else if (conditon == 2)
                {
                    myImage.sprite = Resources.Load("Image/diary124", typeof(Sprite)) as Sprite;
                }
                else if (conditon == 3)
                {
                    myImage.sprite = Resources.Load("Image/diary1234", typeof(Sprite)) as Sprite;
            ...
            }else if (specialPiece.CompareTag("Piece5"))
            {
                ...
                {
                    myImage.sprite = Resources.Load("Image/diary12345", typeof(Sprite)) as Sprite;
                }
            }
    ...
    public void OpenDiary()
    {
        if (!open)
        {
            GetComponent<AudioSource>().PlayOneShot(diarySound);
            Color color = myImage.color;
            color.a = 1;
            myImage.color = color;
            button0.GetComponent<Image>().color = color;
